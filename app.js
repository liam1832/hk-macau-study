...
(function () {
  ...
  const CASE_GROUPS = [
    [ // 本科线
      { tag: "香港",        from: "专科在读 / 毕业",       to: "香港 · 本科",         note: "专科背景，走香港本科升学通道。" },
      { tag: "香港 · 前五", from: "高考特控线 · 英语 120", to: "香港前五 · 本科",     note: "卡线分数，精准匹配专业与录取批次。" },
      { tag: "澳门",        from: "高考本科线上",         to: "澳门科技大学 · 本科", note: "用高考成绩，直接走澳科大本科。" },
      { tag: "澳门",        from: "本科线下约 20 分",       to: "澳门城市大学 · 本科", note: "差一点的分数，也有正规本科可读。" }
    ],
    [ // 硕士线
      { tag: "香港 · 前五", from: "低均分 / 双非本科",     to: "香港前五 · 硕士",     note: "均分不高、双非背景，靠定位与文书突围。" },
      { tag: "香港 · 港八", from: "民办本科",             to: "港八 · 硕士",         note: "民办背景，按匹配度锁定港八院校。" },
      { tag: "香港 · 都会", from: "专科学历",             to: "香港都会大学 · 硕士", note: "专科直接读香港都会大学硕士。" },
      { tag: "香港 · 身份", from: "不看背景",             to: "SPEED · SPACE · 都会 · 高科院", note: "门槛灵活的入学通道，可同步拿香港身份。" },
      { tag: "香港 · MBA",  from: "单证 / 民办本科",       to: "港前三 / 前五 · MBA", note: "单证、民办也能上前三 / 前五 MBA。" },
      { tag: "澳门",        from: "单证 / 民办本科",       to: "澳科大 / 澳城大 · 硕士", note: "材料不全，也能走通的澳门硕士。" }
    ],
    [ // 博士线
      { tag: "香港 · 前五", from: "本科直博",             to: "香港前五 · 博士",     note: "跳过硕士，本科直申港前五博士。" },
      { tag: "香港",        from: "硕士学历",             to: "港前五（看背景）/ 港八（不看背景）· 博士", note: "看背景冲前五，不看背景上港八。" },
      { tag: "澳门",        from: "硕士 · 不看背景",       to: "澳门科技大学 · 博士", note: "不看硕士背景的澳科大博士。" }
    ]
  ];
